  ...
  return (
    <>
      <div className="w-full flex items-center justify-end mt-4 gap-3 ">
        <Button
          className="bg-green-500 flex gap-1 items-center mr-3"
          onClick={() => router.back()}
        >
            ...
            <div className=" mt-5 grid grid-cols-12 p-2 gap-3 md:gap-2">
              ...
              <div className=" col-span-12  md:col-span-6  p-3 text-sm ">
                <div>
                  ...
                  <span>
                    <a href={result.playstore} target="_blank">
                      {result.playstore}
                    </a>
                  </span>
                </div>
              ...
              <div className=" col-span-12  md:col-span-6  p-3 text-sm ">
                <div>
                  ...
                  <span>
                    <a href={result.appstore} target="_blank">
                      {result.appstore}
                    </a>
                  </span>
                </div>
              ...
              {result.images.map((item, index) => (
                <div
                  key={index}
                  className=" col-span-12  md:col-span-6  p-3 text-sm "
                >
                  ...
                  <div className="w-1/2 flex justify-center items-center mt-4">
                    <div
                      className="w-fit bg-red-600 p-2 rounded-md cursor-pointer"
                      onClick={() => deleteHandler(result._id, item)}
                    >
