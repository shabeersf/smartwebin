  ...
  return (
    <Suspense fallback={<LoadingUi />}>
      <div className="px-2 lg:px-4">
        {catList.length > 0 && <PortfolioForm catList={catList} />}
        ...
        <Card className="p-3 shadow-lg mt-4">
          ...
          {portfolio.portfolio && portfolio.portfolio.length > 0 ? (
            <Table>
              ...
              <TableBody>
                {portfolio.portfolio.map((item, index) => (
                  <TableRow key={index}>
                    {" "}
                    {/* Don't forget to add a unique 'key' prop for each mapped element */}
                      ...
                      {item.image ? (
                        <div className="relative  w-[100px] h-[100px]">
                          <Image
                            ...
                            alt={item.title}
                            fill
                            className="  w-[100px] h-[100px] object-cover rounded-md bg-no-repeat"
                          />
                        </div>
                      ) : (
                        ""
            ...
            <p className="text-center mt-4 text-slate-700 font-bold">
              No data found
            </p>
          )}
          <Pagination
